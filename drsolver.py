...
solver.add((i_drdVar_32>=0),(i_drdVar_32<100))
...
wr_cond_0_0 = And (wr_arr_index_0_0 == ((i_drdVar_32 - 1) * (i_drdVar_32 - 1) * (i_drdVar_32 + 2) * (i_drdVar_32 + 3)), (i_drdVar_32>1),(i_drdVar_32%13!=0),(i_drdVar_32%5!=0),((i_drdVar_32*i_drdVar_32*i_drdVar_32)%2!=0))
...
(wr_arr_index_0_0 == wr_arr_index_1_0), (i_drdVar_32 != i_drdVar_23)
)
waw_cond_1 = And( wr_cond_0_0, wr_cond_2_0,
(wr_arr_index_0_0 == wr_arr_index_2_0), (i_drdVar_32 != i_drdVar_14)
)
waw_cond_2 = And( wr_cond_0_0, wr_cond_3_0,
(wr_arr_index_0_0 == wr_arr_index_3_0), (i_drdVar_32 != i_drdVar_7)
)
