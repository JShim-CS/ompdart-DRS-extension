...
wr_cond_0_0 = And (wr_arr_index_0_0 == i_drdVar_19, (i_drdVar_19>0))
wr_cond_0_1 = And (wr_arr_index_0_1 == j_drdVar_19, (i_drdVar_19>0))
wr_cond_0_2 = And (wr_arr_index_0_2 == k_drdVar_19, (i_drdVar_19>0))
wr_cond_0_3 = And (wr_arr_index_0_3 == m_drdVar_19, (i_drdVar_19>0))
waws = False
...
solver.add()
r_cond_0_0 = And (r_arr_index_0_0 == i_drdVar_20 - 1, (i_drdVar_20>0))
r_cond_0_1 = And (r_arr_index_0_1 == j_drdVar_20, (i_drdVar_20>0))
r_cond_0_2 = And (r_arr_index_0_2 == k_drdVar_20, (i_drdVar_20>0))
r_cond_0_3 = And (r_arr_index_0_3 == m_drdVar_20, (i_drdVar_20>0))
r_arr_index_1_0 = Int("r_arr_index_1_0")
r_cond_1_0 = And (r_arr_index_1_0 == 2, True)
...
raws = Or(raw_cond_0)
solver.add(i_drdVar_19 != i_drdVar_20)
