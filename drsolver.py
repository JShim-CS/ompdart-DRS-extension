...
wr_cond_0 = And (wr_arr_index_0 == (i_drdVar_11), ( i_drdVar_11  >= 0) , ( i_drdVar_11 <= len - 1 - 1), True)
waws = False

i_drdVar_12 = Int("i_drdVar_12")
r_arr_index_0 = Int("r_arr_index_0")
r_cond_0 = And (r_arr_index_0 == (i_drdVar_12 + 1), ( i_drdVar_12  >= 0) , ( i_drdVar_12 <= len - 1 - 1), True)
raw_cond_0 = And( wr_cond_0, (wr_arr_index_0 == r_arr_index_0), r_cond_0, (i_drdVar_11 != i_drdVar_12))
raws = Or(raw_cond_0)
